	...
	content: {
				...
				content: {
					...
					items: [
						{
							...
							categories: ['Kategori 1', 'Kategori 3'],
							newsType: 'Nyhed',
						},
						{
							id: 12890,
					...
					frontend: {
						add: [
							{
								endpointUrl:
									'/api/citi/frontend/fc1861cb-094a-415a-b8e0-3c63968f14b8/children',
								...
								fields: [
									...
									},
									{
										...
										label: 'Video',
										helpText:
											'Understøtter links fra YouTube eller DreamBroker.',
									},
									{
										type: 'file',
										name: 'frontendFiles',
									...
									},
									{
										...
										helpText:
											'Overskriver kontaktoplysninger vist under Indholdsansvarlig.',
									},
									{
										type: 'tel',
				...
				content: {
					...
					frontend: {
						add: [
							{
								endpointUrl:
									'/api/citi/frontend/2df5ce9e-a5f5-454c-88b4-c2679ac825b1/children',
					...
					items: [
						{
							image: {
								...
								extension: 'jpg',
								cropUrl:
									'/media/qxxoj0t3/sarah-kilian-52jrtc2s_ve-unsplash.jpg?width=1920&height=1280&v=1dbb85c7656e5b0',
								altText: '',
						...
						},
						{
							image: {
								...
								extension: 'jpg',
								cropUrl:
									'/media/g1chvhpo/ian-dooley-d1upkifd04a-unsplash.jpg?width=2662&height=3993&v=1dbb85cad81d270',
								altText: '',
							},
							showCompleteImage: true,
							text: '',
						...
						},
						{
							image: {
								...
								extension: 'jpg',
								cropUrl:
									'/media/uwzinx3p/edoardo-giudici-saraval-hggist5htgg-unsplash.jpg?width=5304&height=2983&v=1dbb85caea766b0',
								altText: '',
							},
							showCompleteImage: true,
							text: '',
						...
						},
						{
							image: {
								...
								extension: 'jpg',
								cropUrl:
									'/media/ut5djzeh/joseph-gonzalez-ifgrcqhznqg-unsplash.jpg?width=3569&height=5354&v=1dbb85caf056530',
								altText: '',
							},
							showCompleteImage: true,
							text: '',
						...
						},
						{
							image: {
								...
								extension: 'jpg',
								cropUrl:
									'/media/letmj5ot/montironi-valentino-0re0j1vhvzo-unsplash.jpg?width=1920&height=1280&v=1dbb85c7d108be0',
								altText: '',
		...
		frontend: {
			add: [
				{
					endpointUrl:
						'/api/citi/frontend/b7cc4857-2758-463b-81ac-16f32416715d/children',
